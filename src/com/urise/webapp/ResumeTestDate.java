...
//        companies.add(new Organization("Java Online Projects","Java Online Projects","https://javaops.ru/",LocalDate.of(2013, Month.NOVEMBER,1), LocalDate.now(),"Создание, организация и проведение Java онлайн проектов и стажировок."));
//        companies.add(new Organization("Wrike","Wrike","https://www.wrike.com/vm/",LocalDate.of(2014, Month.NOVEMBER,1), LocalDate.of(2016, Month.JANUARY,1),"Проектирование и разработка онлайн платформы управления проектами Wrike (Java 8 API, Maven, Spring, MyBatis, Guava, Vaadin, PostgreSQL, Redis). Двухфакторная аутентификация, авторизация по OAuth1, OAuth2, JWT SSO."));
//        companies.add(new Organization("RIT Center","RIT Center",null,LocalDate.of(2012, Month.APRIL,1), LocalDate.of(2014, Month.NOVEMBER,1),"Организация процесса разработки системы ERP для разных окружений: релизная политика, версионирование, ведение CI (Jenkins), миграция базы (кастомизация Flyway), конфигурирование системы (pgBoucer, Nginx), AAA via SSO. Архитектура БД и серверной части системы. Разработка интергационных сервисов: CMIS, BPMN2, 1C (WebServices), сервисов общего назначения (почта, экспорт в pdf, doc, html). Интеграция Alfresco JLAN для online редактирование из браузера документов MS Office. Maven + plugin development, Ant, Apache Commons, Spring security, Spring MVC, Tomcat,WSO2, xcmis, OpenCmis, Bonita, Python scripting, Unix shell remote scripting via ssh tunnels, PL/Python"));
//
//        List<Organization> education = new ArrayList<>();
//        education.add(new Organization("Coursera","Coursera","https://www.coursera.org/learn/scala-functional-programming",LocalDate.of(2013, Month.MARCH,1), LocalDate.of(2013, Month.MAY,1),"\"Functional Programming Principles in Scala\" by Martin Odersky"));
//        education.add(new Organization("Luxoft","Luxoft","https://www.luxoft-training.ru/kurs/obektno-orientirovannyy_analiz_i_proektirovanie_na_uml.html",LocalDate.of(2011, Month.MARCH,1), LocalDate.of(2011, Month.APRIL,1),"Курс \"Объектно-ориентированный анализ ИС. Концептуальное моделирование на UML.\""));
//        education.add(new Organization("Siemens AG","Siemens AG","https://new.siemens.com/ru/ru.html",LocalDate.of(2005, Month.JANUARY,1), LocalDate.of(2005, Month.APRIL,1),"3 месяца обучения мобильным IN сетям (Берлин)"));
//
//
...
//        resume.sections.put(SectionType.EXPERIENCE, new OrganizationSection(companies));
//        resume.sections.put(SectionType.EDUCATION, new OrganizationSection(education));
//
//
